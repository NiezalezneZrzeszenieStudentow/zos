      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="specjalizacja.php">Specjalizacja</a>
              <a class="dropdown-item" href="wyposazenie.php">Wyposażenie</a>
              <a class="dropdown-item" href="projekty.php">Projekty</a>
              <a class="dropdown-item" href="aktualne_projekty">Aktualne projekty</a>
